...
public class BootIocProj18ProfilesMiniProjectApplication {

	public static void main(String[] args) {
		ConfigurableApplicationContext ctx = SpringApplication.run(BootIocProj18ProfilesMiniProjectApplication.class, args);
